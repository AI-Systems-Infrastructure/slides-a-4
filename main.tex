...
preprocess = weights.transforms()  # Build-in preprocess pipeline
...
\begin{frame}[fragile]{Logging each request}
...and insert a database entry everytime a request is processed.
...
\begin{frame}{Extensions}
    ...
    \vspace{0.5em}
    Finish all three and you have an AI API server that behaves like a real one: authenticates users, tracks usage, limits abuse, and streams responses.
\end{frame}
...
\begin{frame}{What you should walk away with}
    ...
    \begin{enumerate}
        ...
        \item Design and implement an AI API server behaves like a real one
    \end{enumerate}
